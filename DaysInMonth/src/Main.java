...
public class Main {
    ...
    static boolean threeLetterCase(int year, String str) {
        ...
        if(month!=0) return Main.checkDays(year, month);
        else return false;
    }
                ...
                if(!isDigit) {
                    ...
                    if (str1.length() <= 2) {
                        ...
                        if (isDigit) {
                            ...
                            if (month <= 12 && month >= 1) valid=Main.checkDays(year, month);
                            else {
                                JOptionPane.showMessageDialog(null, "Invalid input");
                                valid=false;
                            }
                    ...
                    else if (str1.length() == 3) valid=Main.threeLetterCase(year, str1);
                    else if (str1.length() <= 5) valid=Main.abbreviationCase(year, str1);
                    else valid=Main.fullNameCase(year, str1);
                }
            }
            if(valid) break;
        }
