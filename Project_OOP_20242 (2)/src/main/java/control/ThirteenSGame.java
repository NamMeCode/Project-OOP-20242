...
public class ThirteenSGame {
    ...
    private class ThirteenSRound {
        ArrayList<Actor> playersInRound;
        Actor playerWinRound;
        ListOfCards cardsOnTable = new ListOfCards();

        public ThirteenSRound(ArrayList<Actor> playersInGame, Actor playerStartRound) {
...
//                    decision = true;
        ...
        public Actor getPlayerWinRound() {
